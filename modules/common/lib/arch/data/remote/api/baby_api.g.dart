...
class _BabyApi implements BabyApi {
  ...
  @override
  Future<List<BabyImmunizationResponse>> getImmunization(childId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<BabyImmunizationResponse>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
    ...
    var value = _result.data!
        .map((dynamic i) =>
            BabyImmunizationResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
